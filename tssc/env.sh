...
export IMAGE_URL=${IMAGE_URL-quay.io/tsscui/java-quarkus-oqslydyz:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-org/java-quarkus-oqslydyz-gitops
